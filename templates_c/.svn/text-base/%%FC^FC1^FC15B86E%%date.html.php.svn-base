<?php /* Smarty version 2.6.18, created on 2010-03-10 13:21:57
         compiled from date.html */ ?>
  <div id="mmm">
  <table cellpadding="0" cellspacing="0" id="itemopen">
  <tr>
    <td>
	  <?php echo '<style> 
...
//-->
  ...
  function   popUp()   {   
  newX   =   window.event.x   +   document.getElementById("mmm").scrollLeft   
  newY   =   window.event.y   +   document.getElementById("mmm").scrollTop   
